...
export default function Portfolio() {
  return (
    <section id="portfolio" className="py-24 md:py-32 bg-[#fdf8f5]">
      <div className="max-w-6xl mx-auto px-6">
            ...
            <button
              ...
              className={`px-5 py-2 text-xs tracking-widest uppercase transition-colors ${
                cat === "All"
                  ...
                  : "border border-[#8b5e3c]/30 text-[#2c1810]/60 hover:border-[#8b5e3c] hover:text-[#8b5e3c]"
              }`}
            >
              {cat}
            </button>
            ...
            >
              ...
              <div className="absolute inset-0 bg-[#2c1810]/0 group-hover:bg-[#2c1810]/50 transition-all duration-300 flex items-center justify-center">
                <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-center px-4">
                  <p className="font-[family-name:var(--font-cormorant)] text-white text-xl font-light">
                    {item.label}
                  </p>
        ...
        <div className="text-center mt-12">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-7 py-3 border border-[#8b5e3c] text-[#8b5e3c] text-xs tracking-widest uppercase hover:bg-[#8b5e3c] hover:text-white transition-colors"
          >
